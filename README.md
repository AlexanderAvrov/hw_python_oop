...
## Описание
Программный модуль для расчета и отображения информации о прошедшей тренировке по данным от блока датчиков.
Виды тренировки: бег, спортивная ходьба, плавание. 
Программа выводит информацию о пройденной дистанции, средней скорости и потраченных каллориях. 
